...
var d1=[
 ...
 app.get('/submitForm',function(req,res,next)
{
  res.send(d1);
});
var d2=[
...
app.get('/submitForm2',function(req,res,next)
{
 res.send(d2);
});
...
app.get('/submitForm3',function(req,res,next)
{
 res.send(d3);
});
...
app.get('/submitForm4',function(req,res,next)
{
 res.send(d4);
});
